...
<template>
	<AppSidebar v-if="currentBoard && currentCard"
		...
		<AppSidebarTab id="notifi"
			:order="4"
			:name="t('deck', 'Notification')"
			icon="icon-home">
			<CardSidebarNotification :card="currentCard" />
		</AppSidebarTab>
	</AppSidebar>
</template>
...
import CardSidebarNotification from './CardSidebarNotification.vue'
